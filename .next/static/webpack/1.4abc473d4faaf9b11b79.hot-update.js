...
/* harmony import */ var _styles_module_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./styles.module.scss */ "./src/containers/WorldMap/styles.module.scss");
...
/* harmony import */ var react_globe_gl__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! react-globe.gl */ "./node_modules/react-globe.gl/dist/react-globe.gl.module.js");
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! d3 */ "./node_modules/d3/index.js");
/* harmony import */ var _CountryInfoModal__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./CountryInfoModal */ "./src/containers/WorldMap/CountryInfoModal.tsx");
...
var WorldMap = function WorldMap() {
  var globeEl = Object(react__WEBPACK_IMPORTED_MODULE_4__["useRef"])(null);
  ...
  var fetchData = function fetchData() {
    var featureData;
    return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_3___default.a.async(function fetchData$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_3___default.a.awrap(Object(_api__WEBPACK_IMPORTED_MODULE_6__["getD3Data"])());
  ...
  var fetchDataForMap = function fetchDataForMap() {
    ...
    return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_3___default.a.async(function fetchDataForMap$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_3___default.a.awrap(Object(_api__WEBPACK_IMPORTED_MODULE_6__["getDataForMap"])());
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_4__["useEffect"])(function () {
    ...
    if (globeEl.current) {
      console.dir(globeEl.current.children[1]); // globeEl.current.pointOfView({ lat: 49, lng: 32, altitude: 0.6 });
    }
  }, [_babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_2___default()(globeEl)]);
  var scaleSequentialSqrt = d3__WEBPACK_IMPORTED_MODULE_9__["scaleSequentialSqrt"];
  Object(react__WEBPACK_IMPORTED_MODULE_4__["useEffect"])(function () {
    if (data && countries) {
  ...
  var colorScale = scaleSequentialSqrt(d3__WEBPACK_IMPORTED_MODULE_9__["interpolateYlOrRd"]);
  ...
  var maxVal = Object(react__WEBPACK_IMPORTED_MODULE_4__["useMemo"])(function () {
  ...
  var _onPolygonClick = Object(react__WEBPACK_IMPORTED_MODULE_4__["useCallback"])(function (feature) {
    setModalState(true);
  ...
  return __jsx("div", {
    ...
    className: _styles_module_scss__WEBPACK_IMPORTED_MODULE_5___default.a.worldMapContainer,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 138
    },
    __self: this
  }, __jsx(react_globe_gl__WEBPACK_IMPORTED_MODULE_8__["default"], {
    ref: globeEl,
    ...
    __self: this
  }), selectedCountry && selectedCountry.statistic && __jsx(_CountryInfoModal__WEBPACK_IMPORTED_MODULE_10__["default"], {
    isOpen: isModalOpen,
...
//# sourceMappingURL=1.4abc473d4faaf9b11b79.hot-update.js.map