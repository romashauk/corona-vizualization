...
var WorldMap = function WorldMap() {
  ...
  var getLabelString = function getLabelString(properties) {
    if (properties.statistic) return "\n      <div style='background: red'> ".concat(properties.statistic.name, " ").concat(properties.statistic.deaths, "</div>\n    ");else return "\n      <div>".concat(properties.properties.NAME_SORT, "</div>\n    ");
  };
...
//# sourceMappingURL=1.df5595b67bdec51c7590.hot-update.js.map