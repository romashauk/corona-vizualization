    ...
    if (data && countries) {
      countries.forEach(function (country) {
        ...
        for (var i = 0; i < dataCountriesValues.length; i++) {
          if (dataCountriesValues[i].name === country.properties.NAME_LONG || dataCountriesValues[i].name === country.properties.SOVEREIGNT || dataCountriesValues[i].name === country.properties.NAME) {
...
//# sourceMappingURL=1.2c39f9226fa855ba3a8a.hot-update.js.map